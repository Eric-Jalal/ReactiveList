...
import presenter.NetworkStateViewHolder
import presenter.UserViewHolder

class UserAdapter(private val retryCallback: () -> Unit) : PagedListAdapter<Items, RecyclerView.ViewHolder>(UserDiffCallback) {
    ...
    companion object {
        val UserDiffCallback = object : DiffUtil.ItemCallback<Items>() {
